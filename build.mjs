/**
 * Genera le versioni a file unico dell'app, partendo dagli stessi sorgenti
 * di index.html: niente copie da tenere allineate a mano.
 *
 *   node build.mjs
 *
 * Produce:
 *   dist/leggi-di-piu.html   pagina completa e autosufficiente (si apre con un
 *                            doppio clic, si manda per email, si mette su una
...
<meta name="description" content="Diario di lettura: segna titolo e pagine lette, rispondi alle domande sul contesto e guarda i tuoi progressi. Basta un nome utente.">
